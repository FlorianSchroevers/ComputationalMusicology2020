...
import chart_studio
chart_studio.tools.set_credentials_file(username='awuthme', api_key='nCowYH5RHJvnbh7ShdS1')
...
for pl in playlists:
    track, artist = most_iconic_track(df[df["playlist"] == pl])
    print(f"The most iconic {pl} track is: '{track}' by '{artist}'")
    track, artist = least_iconic_track(df[df["playlist"] == pl])
    print(f"The least iconic {pl} track is: '{track}' by '{artist}'")
    print('\n')
